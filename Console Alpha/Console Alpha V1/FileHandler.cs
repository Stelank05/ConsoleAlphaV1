...
namespace Console_Alpha_V1
{
    public static class FileHandler
    {
        ...
        private static void WriteTeamData(Team playerTeam)
        {
            string filePath = Path.Combine(CommonData.GetSaveFolder(), "Team Data.csv"),
        ...
        {
            string folderPath = Path.Combine(CommonData.GetSaveFolder(), string.Format("Round {0} - {1}", roundNumber, currentRound.GetRoundName()));
